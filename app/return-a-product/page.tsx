  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white flex flex-col">
      ...
      <RmaPromptModal
        open={showRmaModal}
        onYes={() => {
          setFormData((prev) => ({ ...prev, hasRmaPaperwork: true }));
          setShowRmaModal(false);
          setStep(1);
        }}
        onNo={() => {
          setFormData((prev) => ({ ...prev, hasRmaPaperwork: false }));
          setShowRmaModal(false);
          setStep(1);
        }}
      />
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-3xl shadow-xl p-10">
                ...
                <div className="space-y-4 mb-8 bg-gray-50 p-8 rounded-2xl">
                  ...
                  {/* RMA Paperwork Status */}
                  <div className="flex justify-between items-center text-4xl pb-2">
                    <span className="font-semibold text-gray-600">RMA Paperwork:</span>
                    {formData.hasRmaPaperwork === true ? (
                  ...
                  {formData.hasRmaPaperwork === false && (
                    <div className="bg-yellow-50 border-2 border-yellow-300 rounded-xl p-4">
                      <p className="text-3xl text-yellow-800 font-bold text-center">
                         NOTE: Please keep your line open. Our staff will call you to the window once your RMA paperwork is ready.
                      </p>
                    </div>
                  )}
                </div>
