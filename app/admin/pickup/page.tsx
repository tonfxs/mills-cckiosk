...
// import { netoRequest } from "@/app/lib/neto-client"; // adjust if needed
...
//       "ShippingTotal",
//       "Items",
//       // add more selectors if you want
//     ],
//   };
...
//   try {
//     // Most likely you pass OrderNumber from your table (r.orderNumber),
//     // but this fallback makes it robust.
//     const order =
...
//                       onClick={() => setSelectedOrderKey(r.orderNumber)}
//                       role="button"
//                       tabIndex={0}
//                       onKeyDown={(e) => {
//                         if (e.key === "Enter" || e.key === " ") setSelectedOrderKey(r.orderNumber);
//                       }}
//                     >
...
//                         {/* Stop click from triggering twice (row click + button) */}
//                         <button
//                           type="button"
//                           onClick={(e) => {
//                             e.stopPropagation();
//                             setSelectedOrderKey(r.orderNumber);
//                           }}
...
//   // ✅ NEW from MASTER LIST A:M
//   notes: string;       // L
//   netoOrderId: string; // M (Neto internal ID needed for GetOrder Filter.OrderID)
// };
...
//   // ✅ modal state = Neto OrderID (NOT kiosk orderNumber)
...
//     // If no netoOrderId saved yet (older rows), avoid modal 404 loops
//     if (!row.netoOrderId || !row.netoOrderId.trim()) {
//       setError(
//         `No Neto OrderID saved yet for ${row.orderNumber}. ` +
//           `This record likely predates the Neto linking update.`
//       );
//       return;
//     }
//     setSelectedOrderId(row.netoOrderId.trim());
//   }
...
//       {/* ✅ Modal (now uses Neto internal OrderID) */}
//       <OrderDetailsModal
